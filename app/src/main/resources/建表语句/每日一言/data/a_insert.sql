...
('既然没有终点，那在何处又何妨呢。', '异度侵入'),
('人生在世只有一次，不必勉强选择自己不喜欢的路，随性而生或随性而死都没关系，不过，无论选择哪条路，都不要忘记保护自己所珍惜的人。', '火影忍者'),
('只要是人都是依靠自己的知识与认知并且被之束缚生活着的，那就叫做现实。但是知识与认知是模糊不清的东西，现实也许只是镜花水月，人都是活在自己的执念中的。', '火影忍者'),
('当你们试图去寻找死的意义……能找到的……只有痛苦…和不知道归向何方的憎恨……', '火影忍者'),
('我连宇宙尽头在哪里都不知道，怎么会知道这个。', 'JOJO的奇妙冒险'),
('无论世界如何改变，我们都将永不分离。', 'GOSICK'),
('火焰啊，燃烧吧，燃烧吧！照亮……那孩子的未来。', 'GOSICK'),
('牙白得斯内！', '公主连结Re:Dive'),
('不能逃避，不能逃避，不能逃避。', 'EVA'),
('我是为了与你相见才诞生于世的。', 'EVA'),
('我将送你最美的鲜花。', '怪物Monster'),
('我的出生就是为了用鲜花将你淹没。', '怪物Monster'),
('心急火燎地想要长大，明明还是个小鬼。', 'CLANNAD ～AFTER STORY～'),
('在时间的流逝里，没有什么是一成不变的。', 'CLANNAD ～AFTER STORY～'),
('爸爸，我能不再忍了吗？早苗说了，世界上能够放声大哭的地方，只有卫生间，和爸爸的怀里。', 'CLANNAD ～AFTER STORY～ EP18'),
('冈崎，永远都别迷失自己最珍爱的事物啊。', 'CLANNAD ～AFTER STORY～'),
('有些东西不管你怎么努力也无法挽回，也有无论怎么挣扎都逃脱不了的绝望。', '黑执事'),
('你在那么美丽的地方，纯属奇迹般的偶然。', '理科生坠入情网故尝试证明'),
('做好人需要比恶人更狡猾，他们的名字终将成为传说，而真实沉没于历史的波涛中。', '万国志'),
('一旦失去的东西，就再也拿不回来了。', '黑执事'),
('难道我输了吗？', '火影忍者'),
('遇到事情不能坐以待毙。', '捷德奥特曼'),
('我必须要变强，但是孤独居然这么痛苦。', '黑色五叶草'),
('我的回合，抽卡！', '游戏王'),
('再相见，会是怎样的世界？', '升起的烟花，从下面看？还是从侧面看?'),
('憧憬是距离理解最遥远的一种感情。', '死神'),
('两个囚犯从监狱的窗户往外看，一个看到了泥地，一个看到了星星。', 'JOJO的奇妙冒险'),
('我可是要成为海贼王的男人！', '海贼王'),
('人找不到某种东西沉迷就活不下来。人都是某种东西的奴隶。', '进击的巨人'),
('也许我的灵魂彷徨了几万年，不过就是为了与你相遇。', 'JOJO的奇妙冒险·战斗潮流'),
('英雄意味着强大，英雄意味着孤独，最后一幕一定是英雄渐行渐远，我的英雄也是那样的存在。', '四月是你的谎言'),
('世界怎样与我无关，以我自己的意识！', '机动战士高达00'),
('宛如花朵在风中摇摆起舞，宛如雨露滋润大地，这世界的万物相互依存共同延续。', '机动战士高达00'),
('不论目睹怎样的现实 也不要迷失那个说「即便如此」的自我 这就是你的骨气。', '机动战士高达独角兽'),
('たとえどんな现実を突きつられようと それでもと・言い続ける 自分を见失うな。', '机动战士高达独角兽'),
('おれは 人の悲しさを 悲しい感じる心があるんなって事を 忘れなくない それを受け止められる人间になりたいです。', '机动战士高达独角兽'),
('为了维护自己,渐渐地失去,就算无法做好,屡屡受伤 ,也不要心生怨恨。', '樱与抱月'),
('我明白，洛克昂。我是只能选择战斗的破坏者，所以要战斗，为击败催生战争的人，粉碎这扭曲。', '机动战士高达00'),
('无法入眠的凌晨两点，烦躁就像在敲门。', 'RUNNING TO HORIZON'),
('梦是现实的延续，现实是梦的终结。', 'Eva'),
('战斗是残酷的，无法做出多余的考虑！', '机动战士高达'),
('人类的伟大就是勇气的伟大！人类的赞歌就是勇气的赞歌！', 'jojo的奇妙冒险'),
('前天我遇见了小兔，昨天遇见了小鹿，今天则遇见了你。', 'CLANNAD'),
('只要你们不停下来，那前面就一定有我。所以啊，不要停下来……', '机动战士高达 铁血的奥尔芬斯'),
('不管是快乐，还是欣喜，全都……全都不可能永远延续，即使是这样，你也会喜欢这里吗？', 'CLANNAD'),
('如期待奇迹发生，那唯有不停伸手去抓紧，去把握才行', '秒速5厘米'),
('即便分开，羁绊仍然是存在的，这就是所谓的家人。', 'CLANNAD'),
('世界上没有一成不变的事物，所以只要以其他方式找到自己的快乐就行了。', 'CLANNAD'),
('青春总是焦虑的，连一勺砂糖溶于杯中的时间都等不及。后悔带来的苦涩，是对过去的见证，终将逐一化为杯中咖啡的味道。', '玉子爱情故事'),
('今まで生きてきで，今が一番幸せかもしれない。', '言叶之庭'),
('嗯。我的梦想也成真了，美好的回忆也留下了，我想我不会再有什么遗憾了。', '末日时在做什么？有没有空？可以来拯救吗？'),
('他有一双好眼睛，就是他将我从黑暗的迷途中带了回来。', '火影忍者'),
('愿你有一天能与你最重要的人重逢。', '可塑性记忆'),
('干燥的空气，尘埃的味道，我在其中……踏上旅途。', '四月是你的谎言'),
('我向星星许了个愿。我并不是真的相信它，但是反正也是免费的，而且也没有证据证明它不灵。', '加菲猫的幸福生活'),
('这也算是一条路啊，或许这样会更加幸福一些。', '半妖的夜叉姬'),
('我们即使发了一千次短信，心与心之间大概也只能靠近1厘米。', '秒速五厘米'),
('因为拒绝了世间所有的美好，才会比任何人都要温柔。', '空は高く風は歌う - 「Fate/Zero」ED2'),
('I''m bad, and that''s good. I will never be good, and that''s not bad. There''s no one I''d rather be than me.', '无敌破坏王'),
('狙击目标！', '机动战士高达00'),
('齿轮也有齿轮的志气！', '机动战士高达独角兽'),
('爸爸，妈妈，对不起，我，要去了！', '机动战士高达独角兽'),
('从认识你，到和你性命相连，我从未后悔过。', '大鱼海棠'),
('相信朋友是不需要理由的。', '从零开始的异世界生活 第二季'),
('你将不再是工具，而是人如其名的人。', '紫罗兰永恒花园'),
('Explotion！', '为美好的世界献上祝福'),
('现在的我，一定是世界上最幸福的女孩子。', '末日时在做什么？有没有空？可以来拯救吗？'),
('寂寞的时候，就呼唤我的名字吧。', '紫罗兰永恒花园外传'),
('总之就是非常可爱！', '总之就是非常可爱'),
('万水千山，你愿意和我一起看吗？', '狐妖小红娘'),
('这个地方的人们，就是我战斗的理由。', '战翼的希格德莉法'),
('上天给我们生命，一定是为了让我们创造奇迹的。', '大鱼海棠'),
('你的双眼能够看到多远的未来。', '火影忍者'),
('王与坐骑的区别—在于本能！', '死神'),
('自认为为他人好而做的事情，并不一定正确。', '魔女之旅'),
('请别在意。我是旅人，得继续旅行才行。', '魔女之旅'),
('要是有事情不称心，就起身反抗吧。', '魔女之旅'),
('不要就是不要，要学会大声说出口，这样才能保护你自己。', '魔女之旅'),
('当真心想要做成一件事的时候，人总是孤独的，必须孤身一人，相互依赖上就完了。', '魔女之旅'),
('温柔与美丽，偶尔也是残忍的。', '魔女之旅'),
('“为什么要选择这条路”这种问题，是决不能问出口的，只有在暴风雨里问自己。', '三月的狮子'),
('小的时候，总认为世界是单纯的。', '游戏人生 zero'),
('这个世界对温柔的你可一点也不温柔呀。', '军火女王'),
('蔷薇不管被冠以什么名字，却依旧可以芳香扑鼻。', '我的青春恋爱物语果然有问题'),
('伤害别人的人，要有被别人伤害的觉悟。', '罪恶王冠'),
('人可以为他人舍弃自身的生命，但并不代表你我的伟大。伟大的、美丽的是已经逝去的他们，我们只是卑微地、愚昧地、苟延残喘地，在这地狱中挣扎，匍匐着拼命求生，仅此而已。', 'UN-GO'),
('有时写信才能表达，平时难以说出口的心声。', '紫罗兰的永恒花园'),
('我和空太是恋人以上，友人未满的关系。', '樱花庄的宠物女孩'),
('愿你和重要的人，在来日重逢。', '可塑性记忆'),
('When the dawn is close inside, we never say good-bye and never see again.', '末日时在做什么？有没有空？可以来拯救吗？'),
('我会欺骗你，欺骗世界，欺骗自己。', 'Princess Principle'),
('好想尝试一下把整颗心都掏出来献给爱人的感觉，我能体验吗？那种恋爱。', '青春纪行'),
('我们还没年老到，对被注定的未来，欣然接受的年纪。想要去到更高的地方，我们便无所畏惧。', '数码宝贝：最后的进化 絆'),
('就一会儿，再在这里待一会儿好吗？我要把你深深地印在脑海里，为了只要闭上眼，就能随时见到花丛中的你。', '元气少女缘结神◎ 10集 21:55'),
('独步天下，吾心自洁，无欲无求，如林中之象。', '攻壳机动队Ⅱ无罪'),
('连繁星都不是永恒的，何况是人呢。', '中二病也要谈恋爱！'),
('每段灿烂的回忆，都是琐碎的小事，是我一直珍藏的宝物，只要你能将这其中任何一件事记在心里，毫不夸张的说，那便足以支撑我活下去。这世上谁都不及你好。', '人渣的本愿'),
('回忆都是美好的，记忆却是痛苦。回忆全部被记录下来，可记忆不一定能想起来。', '全部成为F'),
('我的恋爱还没有开始就结束了。', '樱花庄的宠物女孩'),
('十年前的你，喜欢过我吗？', '路人女主的养成方法'),
('有时写信才能表达，平时难以说出口的心声。', '紫罗兰的永恒花园'),
('没有一封信不必要被送达，因为没有一份思念不需要被送达。', '紫罗兰的永恒花园'),
('唯有前进，才能享受这被诅咒的疯狂。', '机动战士高达雷霆宙域'),
('不可以逃避！活下去！活下去也是一种战斗！', '机动战士高达独角兽'),
('你可以祈祷，但神不会倾听。', '寂静王冠'),
('——比起自己的生命还要重要的东西，并不是这么好找的。', '末日时在做什么？能不能再见一面？'),
('恩，好像做了很多梦呢，快乐的，悲伤的，每个都很短，但是全都很珍贵。', '末日时在做什么？有没有空？可以来拯救吗？'),
('所以，请你抬起头，笑着为我的旅途祝福吧。 一直以来谢谢你陪伴我，听我的那些谎话。和你的相遇，是我一生最珍贵的记忆。', '死后文'),
('谁说死后文只能寄信件。 清澄才藏君， 你寄出的，是五十年不变的誓约。', '死后文'),
('所谓的奇迹正是由于其耀眼而短暂的光芒而被成为奇迹。奇迹终将过去，而过去之后一切会归于沉寂。', '成神之日'),
('战争是什么？战争只不过是一群人对于另一群人的屠杀，只不过是屠杀的对象有所不同而已。', '紫罗兰的永恒花园'),
('对于那个被照顾的人，她剩下的人生变得不再孤单寂寞，变得不再因为生命必然的终结而不能沾染上明丽的色彩。', '仰望半月的夜空'),
('收获了，名为夏日回忆的宝物。', '侦探已经死了'),
('精神上，没有上进心的人，是笨蛋！', '归宅部活动记录'),
('下次见到你时，希望你也能成为永不凋零的希望之花。', '火影忍者'),
('有一种说法是「恋爱就是一场梦」，既然是梦的话，只要给她一点时间，总是会醒的。', '中二病也要谈恋爱！'),
('只要轻唤你的名字，我们的羁绊就永远不会消逝。', '紫罗兰永恒花园'),
('最后我还想再拜托你一件事，希望你可以把我忘掉。', '末日时在做什么？有没有空？可以来拯救吗？'),
('你不能因为喜欢一个人就把自己的生活扰乱​。', '开心超人'),
('人生当苦无妨，良人当归即好。', '雪中悍刀行'),
('跌落谷底之后，唯有向上攀爬。', '排球少年'),
('优秀的幼苗应该有与之相称的土壤，贫瘠的土地是无法结出丰盛果实的。', '排球少年'),
('不管对手是强是弱，结果只有胜负两种。输了的话，就无法站在球场上了。', '排球少年'),
('才能是可以栽培开花的，灵感是可以研磨雕琢的。', '排球少年'),
('如果今天是最糟糕的，那么明天一定比今天美好，不是吗？', '未来日记'),
('人们把自己不能理解的状态称之为疯狂。', '尸者的帝国'),
('我的梦想是不失去任何东西让所有人笑着回来。', '某科学的超电磁炮'),
('在染成红色的天空下，在雨中，流淌着，漂浮着的，最软弱的自己的倒影，朦胧蓝色的回忆。', '知晓天空之蓝的人啊'),
('彩虹不只是天上才有，也可以在心中架起。', 'P.A.R.T.Y假面骑士ZIO剧场版主题曲'),
('尽管我们的手中空无一物，却能因此紧紧相牵，当你一人时请别迷茫，因为我无论何时都不会放手。', '尽管我们的手中空无一物'),
('就因为没有好事发生，所以至少要保持微笑。', '阴晴不定大哥哥'),
('是你，是你，告诉我，若能在黑暗中绽放光芒，便能化作星空，悲伤化作笑颜，已经无需隐藏，漫天闪耀着的星光，都会为你照亮前行。', '四月是你的谎言'),
('即使得不到旁人的认同，即使不曾拥有像样的地位，我们小小的双手也一定，能为明天的某人带去笑容。', '尽管我们的手中空无一物'),
('宁愿带着浑身伤痛勇敢站起 让泪水洒满尘埃与苍穹之间。', '机动战士高达NT'),
('来看看你的脚下，这就是你要走的路。', '未来へ(向着未来)'),
('来看看你的未来，那就是你的未来，向着未来，一步一步地走去。', '未来へ(向着未来)'),
('晨意微寒秋渐深，侧伴无事俏佳人。', 'WHITE ALBUM 2'),
('长大后就忘了吗？曾经拥有的梦想。', '哆啦A梦'),
('认识你，即是你的命运，也是我的命运，我们成为好朋友，我们的命运就都一下好了，而我们成为敌人，我们的命运就一起坏了。', '魁拔'),
('我不幸的理由有无数个，我今后依然不幸的理由有无限个。不过，我不能幸福的理由连一个都没有。', '愚物语'),
('送走人间种种别离，送走世间种种变迁，逝者如斯，时光永远不会止步；我们会再度与人萍水相逢，相识相知，一同织下我们的人生。', '朝花夕誓'),
('我期待着，在能够看到北极光的地方，与你再一次相逢。', '死后文'),
('我觉得我们可以成为朋友，因为，我们截然相反啊。', 'Princess Principal'),
('只要不停下来，前进的道路就会不断延伸。', '机动战士高达铁血的奥尔菲斯'),
('Just a page of life in my story，Sweet and bright.', 'Princess Principal'),
('Vanish worries the light has come. I''m going to try for a pleasant now.', 'Princess Principal'),
('女人的心，木卫三的天。', '星际牛仔'),
('借君三十年，繁花万里好江山。', '天行九歌'),
('人的感受，真的很复杂很纤细，没人会把所有想法说出口，时而矛盾，时而撒谎。', '紫罗兰永恒花园'),
('濒临死亡的体验其实很美妙，只是大多数人在体验过后就再也没有机会跟别人谈论这种感受了。', '魁拔之书第二卷'),
('我愿用我余生换你岁月如歌，奈何阳错阴差，也许同归无路，究竟殊途……', '魁拔'),
('星星和月亮其实都反射太阳的光亮，尽管暂时乌云密布，但只要找到那束光，我们依旧可以一起闪耀.', '你的名字'),
('放任误解就是撒谎。', '鬼物语'),
('创作是很难为情的事情，而梦想也是很难为情的事情。这是没办法的事，这都是理所当然的。', '恋物语'),
('给予胜者褒奖，对败者施以惩罚。', 'BLOOD-C'),
('你知道雪为什么是白色的吗？因为它忘记了自己曾经的颜色。', '叛逆的鲁路修'),
('我能唱歌，因为我并不孤单！', 'LoveLive!Superstar!!'),
('从你的前前前世开始，我就一直在寻找你的踪迹。', '你的名字'),
('ぼんぼる.', '花开伊吕波'),
('爱总在阳光里，即使看不见，即使摸不到，也在你身旁。', 'Letter'),
('白羽哀婉不容于天空之湛蓝、亦不容于海之绀碧。', 'Little busters'),
('那仅仅是恶作剧的心理，也许会对他人造成无法忍受的痛苦，你知道这样的人也是存在的吗？', 'Little busters'),
('天气什么的，就让它失控好了！', '天气之子'),
('就算是我，也可以战斗，就算是我，也可以成为你的力量！', '魔法禁书目录'),
('时光流转，愿你终有一天能和你重要的人重逢。', '可塑性记忆'),
('读书固然重要，但是梦想也很重要。', '喜羊羊与灰太狼之筐出未来'),
('因为，音乐剧，是能引发奇迹的哦。', '心灵想要大声呼喊'),
('当毫无寄托的两颗心紧挨之时，真正的悲伤开始展翅翱翔。', '空之境界'),
('正因为知道可以在空中翱翔，才会畏惧展翅的那一刻而忘却疾风。', '空之境界'),
('从0开始，直到1。', 'Love Live!'),
('我也有过，只要能用下手姿势把球都接起来，就足够了的想法，而且也自认为确实能够做到这一点，但古人说得好，学无止境啊；明知道自己可以更进一步还不去努力进取的话，不就太无聊了吗？', '排球少年'),
('……让才能能真正开花结果的机会也许就在今天，又或者是明天、后天，又或者是明年。', '排球少年'),
('有朝一日，记忆也许会渐渐淡薄，也许连她的声音、她的神态也都忘记。即使如此，我喜欢过一个叫Saber的人这件事，我绝对不会忘。', 'Fate Stay/night'),
('所谓恋爱，只会使人蒙昧。', '紫罗兰的永恒花园'),
('You just have to embrace the chaos and not worry about it.', '外星也难民'),
('你果然在说谎啊，根本就没“人”在里面。', 'school days'),
('We''re cynical and we''re sad and we''re mean.', '马男波杰克'),
('努力的活完短短的一生，把成果留给后代继承，人类就是如此反复慢慢成长，真的很了不起。', '迪迦奥特曼'),
('乘清风展白翼与君行，群青狭间，常夏之岛。', 'little busters！'),
('我已经逃避得太久了，现在终于等来了一个我愿意誓死守护的人，就是你。', '哈尔的移动城堡'),
('我叫江户川柯南，是个侦探。', '名侦探柯南'),
('我只能送你到这里了，剩下的路你要自己走，不要回头。', '千与千寻'),
('吶，你想成为什么颜色？', '樱花庄的宠物女孩'),
('现实中的人生不像游戏中那么简单。', '名侦探柯南剧场版：贝克街的亡灵'),
('过去的幸福，可以把不幸的人，推入更深的绝望。', '魔女之旅'),
('明明这个世界如此美好，可是这个世界上只有我一个人。', '云之彼端，约定的地方'),
('为王的诞生，献上血与泪编制而成的罪恶王冠。', '罪恶王冠'),
('我喜欢了你十年，却用一整个四月编织了一个不爱你的谎言。', '四月是你的谎言'),
('在这251秒内，堵上我所拥有的一切！', '游戏人生·零'),
('梦里不觉秋已深，余情岂是为他人。', 'WHITE ALBUM2'),
('水面的涟漪虽然暂时消失了，但仍会有人记得，风曾经吹过。', '天行九歌'),
('哈尔那你到底有多少名字呢？——刚好够我自由地活下去。', '哈尔的移动城堡'),
('人老了唯一的好处就是能失去的东西少了。', '哈尔的移动城堡'),
('真実はいつもひとつ！', '名侦探柯南'),
('绝望的世界没有丝毫存在的价值。', '火影忍者'),
('集中一点，登峰造极！', '鬼灭之刃'),
('我将一直找寻，为你翻遍这世上所有的宝石，每日每夜我都为你痛苦地哭泣，犹如你一次又一次地呼唤我，而在我灵魂深处，我听见了你的呼唤。', '机动战士高达NT'),
('与你在夏末约定，将来的梦想，远大的希望，别忘记：十年后的八月，我相信我们还能再相遇，共创最美好的回忆...', '君がくれたもの~'),
('你最后一直在心底呼喊着『谢谢你』，我是知道的很难过呢，强忍着泪水笑着说再见，那一段最美好的回忆.....', '君がくれたもの~'),
('愿闪耀的你和宇宙，永远不会奏响憎恨的音色，愿这趟旅途，如同永恒的的时光，能永远延续........', 'THE BEYOND-機動戦士ガンダム40周年纪念曲'),
('愿悲 、爱恋、你和宇宙以及那颗星辰，能够永远拥抱我们。', 'THE BEYOND-機動戦士ガンダム40周年纪念曲'),
('愿你们的旅途充满诅咒与祝福。', '来自深渊'),
('人类，既弱小，又不完全，所以才值得托付啊!', '机动战士高达UC'),
('如果生命只有痛苦，倒不如一开始就不要了，我到底是为了什么.....', '机动战士高达'),
('牛高达可不只是好看而已!', '机动战士高达'),
('第一次去卢浮宫时，并没有什么特别的感觉，因为独属于我的蒙娜丽莎，我早已遇见。', 'EVA:One Last Kiss'),
('漫长岁月后，也许会有那样一个人，独自站在岁月长河上，回首万古，独伴神道。', '完美世界'),
('我不再逃避了，我要改变，接受一切，以自己为豪，来爱龙儿。', '龙与虎'),
('我真的是high到不行啊！', 'JOJO的奇妙冒险'),
('你遇见一个人，犯了一个错，你想弥补想还清，到最后才发现你根本无力回天，犯下的罪过永远无法弥补。', '大鱼海棠'),
('我们永远无法还清欠下的，只要错了，就是错了永远无法弥补。', '大鱼海棠'),
('不会伤及他人，也不会脏了自己的手，也算是种善良的生存方式吧，就这样一无是处的消失。', '假面骑士Amazons'),
('如果存活在世上便是无法抹灭的罪恶的话，活着是否就要背负着惩罚呢？', '假面骑士Amazons'),
('今天又一次将你的言语拥入心中，因那对于我而言宛若月明之光，正如我们那天一起仰望的那般美丽。', '月色真美'),
('愿你能与你重要的人再次相遇。', '可塑性记忆'),
('恶鬼缠身！', '斩！赤红之瞳'),
('你必须认同只能成为如今的你自己。', '四叠半神话大系'),
('那夜我推开了窗，招来了风和奇迹。', '未来都市NO.6'),
('我不曾活着，又何必害怕死亡。', '隐之王'),
('瞬间即是永恒！', '游戏王GX'),
('翻涌的银河，现在在此化作怒涛之光现出身姿吧！', '游戏王zexal'),
('繁星流动的痕迹纺织出所有的心愿，与希望一起充满这个世界吧！', '游戏王5DS'),
('一味地追求理想，总有一天会被现实背叛。', '名侦探柯南：绯色的子弹'),
('我的小鱼你醒了，还认识早晨吗？昨夜你曾经说，愿夜幕永不开启。', '魁拔'),
('我并不是要失去自由，而是要去收获那无可替代的不自由。', 'SSSS.电光机王'),
('没有人害怕死亡，害怕的只是死亡的过程，如果不受痛苦就能死去的话，那么谁都不会害怕死亡。', '全部成为F'),
('王的决斗必须是娱乐！', '游戏王5DS'),
('王只有一个！那就是我！', '游戏王5DS'),
('贯穿宇宙的雄叫啊，追溯回遥远的过去，从银河之源苏醒吧。现身吧！引导我向胜利!', '游戏王zexal'),
('英雄也有适合英雄战斗的舞台！', '游戏王GX'),
('天下有道，以道殉身；天下无道，以身殉道。', '识夜描银'),
('如果能不长大该有多好，可时光在身后挡住退路。', '未闻花名'),
('别为失败做打算，那比庸常的打算还愚蠢。', '瑞克和莫蒂'),
('只要有想见的人，就不是孤身一人。', '夏目友人帐'),
('当你准备好的时候，死神就追不上你。', '机动战士高达'),
('有些人没有见过汪洋，以为江河最为壮美；而有些人，通过一片落叶，却能看到整个秋天。', '天行九歌'),
('十年可见春去秋来，百年可证生老病死；千年可叹王朝更替，万年可见斗转星移；凡人如果用一天的视野，去窥探百万年的天地，是否就如同井底之蛙。', '天行九歌'),
('如果自己一个不行，那么请相信自己身后的好兄弟！', '喜羊羊与灰太狼'),
('我的朋友，我会用自己的力量来守护！', '羊村守护者'),
('无论遇到什么困难，我们从不放弃彼此！', '羊村守护者'),
('别忘了，我们是羊村守护者！', '羊村守护者'),
('阿虚，电话。', '凉宫春日的忧郁'),
('我也很没用，但是两个人一起的话，就会变得很坚强。', 'Clannad'),
('如果你捡到这个小熊，请把它交给我们的女儿。', 'Clannad'),
('无论前方如何，请不要后悔与我相遇。', 'Clannad'),
('如果在明天起床之后，发现我们变成了一对恋人，你会觉得很有意思吗？', 'Clannad'),
('云会变，树会变，山川河流会变，哪能奢求别人，永远不改变呢。', '思无邪'),
('失去了个性，和死掉没区别。', '孤独摇滚'),
('你们中的人，我已经忘记了一半以上。', '末日时在做什么？有没有空？可以来拯救吗？'),
('我什么都不知道哦，只是你自己知道而已——阿良良木学长。', '终物语'),
('山内有樱名为良，树本无名只待春。', '我想吃掉你的胰脏'),
('樱花生在深山内，春树志向贺新春。', '我想吃掉你的胰脏'),
('樱花易逝，春树常青。', '我想吃掉你的胰脏'),
('真一郎的鞋里有蟑螂，真一郎的心里是——汤浅比吕美。', '真实之泪'),
('井底之蛙不曾见过大海，但见过湛蓝的天空。', '知晓天空之蓝的人啊'),
('这只是乌龙茶啦。', '碧蓝之海'),
('人生就是不公平的，慢慢习惯吧。', '海绵宝宝'),
('秋至叶始落，叶落方知秋，秋为叶生，叶因秋落，一叶一苏，平分秋色。', '全职高手'),
('人要是死了，就看不见这么美的天空了。', '大鱼海棠'),
('只要有树叶飞舞的地方，火就会燃烧。火的影子会照耀着村子，并且，让新的树叶发芽，当想要保护自己做珍惜的人时，忍者真正的力量才会表现出来。', '火影忍者'),
('时光流逝，愿你与所爱之人再度重逢。', '可塑性记忆'),
('In solitude, where we are least alone.', 'ヨスガノソラ'),
('我把石田君努力建立起来的一切全毁了。', '声之形'),
('我不知道我在哪里，要做什么，但是即使拼上性命，我也要守护她。', '天空之城'),
('若能与你化作星座，一起描绘星空中的梦想。', '星座になれたら'),
('背负着火影之名，我不能输！', '火影忍者'),
('如何摆脱毫无意义的生活？                                                            非常简单，把每天都当做生命最后一天来过。', '海绵宝宝'),
('谁都会犯错误， 所以人们才在铅笔的另一头装上橡皮 。', '海绵宝宝'),
('爱的真谛，就是金钱买不到真爱，只会赐给你真爱！', '海绵宝宝'),
('没有相同的经历是无法相互感受的。', '火影忍者'),
('闪电风暴过后，一定是那充满蓝天白云，充满碧草繁花的世界。', '天空之城'),
('如谷之歌，扎根土里。与风共存，与种子越冬，与鸟歌颂。', '天空之城'),
('月光里的云海。她静静的飘下，带着远方的他的梦，一起飞翔。', '天空之城'),
('これじゃ 一生 一生 一生 歌えない', 'ラブソング歌えない'),
('我们所度过的每个平凡的日常，也许就是连续发生的奇迹。', '日常');
